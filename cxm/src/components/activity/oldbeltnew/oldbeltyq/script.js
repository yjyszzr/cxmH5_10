				...
				.then(res => {
					if (res.code == 0) {
                        ...
                        if(res.data.invitationNum>=10){
                            this.$refs.numsItem[0].style.background = '#d12120'
                        }
                        if(res.data.invitationNum>=20){
                            this.$refs.numsItem[1].style.background = '#d12120'
                        }
                        if(res.data.invitationNum>=30){
                            this.$refs.numsItem[2].style.background = '#d12120'
                        }
                        if(res.data.invitationNum>=40){
                            this.$refs.numsItem[3].style.background = '#d12120'
                        }
                        if(res.data.invitationNum>=50){
                            this.$refs.numsItem[4].style.background = '#d12120'
                        }
                        if(res.data.invitationNum>=100){
                            this.$refs.numsItem[5].style.background = '#d12120'
                        }
                        if(res.data.invitationNum<=10){
