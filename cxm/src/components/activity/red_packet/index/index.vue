        ...
        <div class="pack_center">
            ...
            <div class="box">
                ...
                <div class="rule">
                    <h5>注意事项</h5>
                    <div>
                        <p>1、本次活动时间为即日起至7月25日23:59:59，活动时间截止则默认本次活动自动结束。具体使用范围以红包券显示为准。请在个人中心“我的卡券”中查看。</p>
                        <p>2、用户参加本次活动充值的金额，仅限用户支付购彩使用，不可提现。</p>
                        <p>3、活动期间，如有玩家通过恶意、重复注册等方式参与本次活动，网站有权冻结其账户并保留追责权利，对已赠送的卡券，网站有权要求用户返还。</p>
                        <p>4、如遇不可抗力因素，网站有权在活动期间更改活动规则，用户应随时关注网站公告。</p>
                        <p>5、如有问题，请拨打客服电话咨询：400-012-6600。</p>
                        <p>6、本活动最终解释权归彩小秘彩票所有。</p>
                    </div>
                </div>
                <div class="heit"></div>
            </div>
