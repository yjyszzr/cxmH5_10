...
const router = new Router({
    ...
    routes: [
        ...
        },
        {
            ...
            component: resolve => require(['@/components/serviceModule/kaijiang/index.vue'], resolve)
        },
        {
            path: '/servicemd/kaijiang/:playname',
            name: 'lishi',
            meta: {
                title: '开奖历史'
            },
...
//    一期活动相关路由
        ...
        //电竞列表
        {
            path: '/electricContest/gameList',
            name: 'gameList',
            component: resolve => require(['@/components/entrySpecies/electricContest/gameList.vue'], resolve)
        },
        //电竞投注列表
        {
            path: '/electricContest/touzhuList',
            name: 'touzhuList',
            component: resolve => require(['@/components/entrySpecies/electricContest/touzhuList.vue'], resolve)
        },
        //投注
        {
            path: '/electricContest/touzhu',
            name: 'touzhu',
            component: resolve => require(['@/components/entrySpecies/electricContest/touzhu.vue'], resolve)
        }
    ]
})
